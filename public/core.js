  ...
  function navTo(page) {
    ...
    if (page === 'settings')    { rdmRender(); typeof renderGradingDifficultyUI === 'function' && renderGradingDifficultyUI(); typeof _loadOrgKnowledgeUI === 'function' && _loadOrgKnowledgeUI(); }
